...
class Vault:
    def __init__(self):
        self._master_key = os.environ.get("VAULT_MASTER_KEY")
        if not self._master_key:
            ...
            print("[VAULT] Defina a variável de ambiente 'VAULT_MASTER_KEY' para usar a mesma chave entre reinicializações.")
